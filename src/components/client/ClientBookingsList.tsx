  ...
  if (bookings.length === 0) {
    return (
      <div className="text-center py-8">
        <p className="text-gray-600 mb-4">لا توجد حجوزات حالية</p>
        <Link 
          ...
          {bookings.map((booking) => (
            <tr key={booking.id}>
              <td className="px-6 py-4 whitespace-nowrap text-right">
                ...
                <div className="text-sm text-gray-500">{booking.services.price} ريال</div>
              </td>
              <td className="px-6 py-4 whitespace-nowrap text-right">
              ...
              <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                <Link href={`/client/bookings/${booking.id}`} className="text-pink-600 hover:text-pink-900 ml-4">
                  عرض التفاصيل
                </Link>
